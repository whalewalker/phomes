      ...
      return (
            <div className="service-grid">
                  <div className="land">
                       ...
                       <p>Looking to buy land ? PTwins Nigerial Limited offers the best Land and House purchase packages. We hav an array of listings accross different locations that you'll love. 
                             <br /> <br />
